...
bugs_order = [1 381 292 110 280 225 179];
clear names
...
clear mat_changed
treatfailure = UTI_cases.treatfailure;%   UTI_cases.next_SMP_days<29 & UTI_cases.next_SMP_days>4;
...
% if ismember(drug,[2 4 6 8])
% xticks(1:length(bugs_order))
yticklabels([])
xticklabels([])
% xtickangle(45)
% end
% if ismember(drug,[1 5])
